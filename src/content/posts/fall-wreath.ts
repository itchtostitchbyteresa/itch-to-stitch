...
slug: "fall-wreath",
  title: "Autumn Wreath",
  date: "2024-10-04", 
  tags: ["fall", "wreath", "inspiration","autumn","crochet","leaf"],
  excerpt:
...
with gauge. I just made a leaf, liked how it looked, and kept going from there.😅 </li>
  ...
  <div class="md:w-1/3">
    <img 
      ...
      alt="details autumn wreath leafs" 
      class="rounded-xl w-full"
    />
  </div>
</div>
<h2 class="font-logo text-rose-700 text-2xl mt-10 mb-3">Leaf Mix</h2>

 <div class="flex flex-col md:flex-row items-center gap-6 my-8">
    <img src="https://res.cloudinary.com/dl7fmgr2s/image/upload/v1757696734/accorn_detail_fbvvi7.png"
     alt="details autumn wreath accorn"
     class="w-full md:w-1/3 rounded-xl" />
