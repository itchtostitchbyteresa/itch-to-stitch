...
slug: "fall-wreath",
  ...
  <p>A cozy circle of yarn and leaves. Made with leftover yarn and some online inspiration.</p>
...
<div class="flex flex-col md:flex-row items-center gap-6 my-8">
    ...
    For inspiration, I used the Fabulous Fall Wreath as inspiration. You can get the pattern 
...
<div class="flex flex-col md:flex-row items-center gap-6 my-8">
    <img src="https://res.cloudinary.com/dl7fmgr2s/image/upload/v1757693466/cover_wreath_u2qulr.png"
     alt="Inspiration wreath"
     class="w-full md:w-1/3 rounded-xl" />
    <p class="text-gray-700 leading-relaxed">
...
I just made a leaf, liked how it looked, and kept going from there.😅
  ...
  <div class="md:w-1/3">
    <img 
      src="https://res.cloudinary.com/dl7fmgr2s/image/upload/v1757696680/leafs_detail_phgfpz.png" 
      alt="Metal wreath ring" 
      class="rounded-xl w-full"
    />
  </div>
 ...
 <div class="flex flex-col md:flex-row items-center gap-6 my-8">
    <img src="https://res.cloudinary.com/dl7fmgr2s/image/upload/v1757696734/accorn_detail_fbvvi7.png"
    ...
    and the larger grapes</strong>, I used leftover yarn scraps, but you can use any filling you have on hand. I hot  glued some of the 
    leafs to the base and sew the rest on top of each other.
</p>
</div>

<p>For more inspiration you can check
